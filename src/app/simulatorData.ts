...
export const DICTIONARY = {
  en: {
    navTitle: "Navigation",
    fanExp: "Fan Experience",
    orgDash: "Organizer Dashboard",
    greenGoal: "Green Goal 2026",
    recyclingTarget: "Stadium recycling target: 95%",
    current: "Current",
    selectLang: "Select Language",
    fanPortal: "⚽ Fan Portal",
    commandCenter: "🛠️ Command Center",
    stadiumOps: "MetLife Stadium Ops",
    aiAssistant: "GenAI Assistant",
    arenaMap: "Interactive Arena Map",
    transitHub: "Transit & Fan Hub",
    travelSchedules: "Matchday Travel Schedules",
    ecoCupTitle: "Eco-Cup Rewards",
    ecoCupDesc: "MetLife Stadium utilizes smart returnable cups. Return yours to a recycling bin and scan the barcode below to earn reward tokens for concession discounts!",
    greenPoints: "YOUR GREEN POINTS",
    scanBtn: "Scan Cup Code",
    activeIncidents: "Active Incident Feed",
    opsControl: "Arena Operations Control",
    avgGateWait: "Avg Gate Wait",
    crowdIndex: "Crowd Density Index",
    liveFlow: "Live Flow",
    steadyFlow: "Steady flow",
    scenarioSimulator: "Live Incident Scenario Simulator",
    simulatorDesc: "Trigger simulated matches event conditions to see how the GenAI recommendations and map visualization adapt in real time.",
    selectIncidentHelper: "Select an incident card or map marker to view AI recommendations and dispatch resources.",
    incidentDescTitle: "Incident Description:",
    dispatchBtn: "Dispatch Crew",
    resolveBtn: "Mark Resolved",
    cancelBtn: "Cancel",
    aiDispatchBtn: "AI Dispatch Analysis",
    activeAlerts: "Alerts"
  },
  es: {
    navTitle: "Navegación",
    fanExp: "Experiencia de Fan",
    orgDash: "Panel de Organizador",
    greenGoal: "Meta Verde 2026",
    recyclingTarget: "Objetivo de reciclaje: 95%",
    current: "Actual",
    selectLang: "Seleccionar Idioma",
    fanPortal: "⚽ Portal de Fanáticos",
    commandCenter: "🛠️ Centro de Mando",
    stadiumOps: "Ops de Estadio MetLife",
    aiAssistant: "Asistente de GenAI",
    arenaMap: "Mapa Interactivo del Estadio",
    transitHub: "Centro de Transporte y Fans",
    travelSchedules: "Horarios de Viaje del Día de Partido",
    ecoCupTitle: "Recompensas Eco-Cup",
    ecoCupDesc: "MetLife Stadium utiliza vasos inteligentes retornables. Devuelve el tuyo a un contenedor de reciclaje y escanea el código para ganar tokens de descuento.",
    greenPoints: "TUS PUNTOS VERDES",
    scanBtn: "Escanear Código",
    activeIncidents: "Canal de Incidentes Activos",
    opsControl: "Control de Operaciones",
    avgGateWait: "Espera en Puertas",
    crowdIndex: "Densidad de Multitud",
    liveFlow: "Flujo en Vivo",
    steadyFlow: "Flujo Estable",
    scenarioSimulator: "Simulador de Escenarios en Vivo",
    simulatorDesc: "Active condiciones simuladas de partidos para ver cómo se adaptan las recomendaciones de IA y el mapa en tiempo real.",
    selectIncidentHelper: "Seleccione un incidente o marcador de mapa para ver las recomendaciones de IA y despachar recursos.",
    incidentDescTitle: "Descripción del Incidente:",
    dispatchBtn: "Despachar Equipo",
    resolveBtn: "Marcar Resuelto",
    cancelBtn: "Cancelar",
    aiDispatchBtn: "Análisis de Despacho IA",
    activeAlerts: "Alertas"
  },
  fr: {
    navTitle: "Navigation",
    fanExp: "Expérience Supporter",
    orgDash: "Tableau de Bord",
    greenGoal: "But Vert 2026",
    recyclingTarget: "Objectif de recyclage : 95%",
    current: "Actuel",
    selectLang: "Choisir la Langue",
    fanPortal: "⚽ Portail Supporters",
    commandCenter: "🛠️ Centre de Commande",
    stadiumOps: "Ops du Stade MetLife",
    aiAssistant: "Assistant GenAI",
    arenaMap: "Plan Interactif de l'Arène",
    transitHub: "Hub Transit & Supporters",
    travelSchedules: "Horaires des Transports de Match",
    ecoCupTitle: "Récompenses Eco-Cup",
    ecoCupDesc: "Le MetLife Stadium utilise des gobelets consignés. Rapportez-le à un bac de tri et scannez le code pour obtenir des réductions.",
    greenPoints: "VOS POINTS VERTS",
    scanBtn: "Scanner le Gobelet",
    activeIncidents: "Flux d'Incidents Actifs",
    opsControl: "Contrôle des Opérations",
    avgGateWait: "Attente aux Portes",
    crowdIndex: "Densité de Foule",
    liveFlow: "Flux en Direct",
    steadyFlow: "Flux Régulier",
    scenarioSimulator: "Simulateur de Scénarios en Direct",
    simulatorDesc: "Déclenchez des conditions simulées pour voir comment les recommandations GenAI et le plan s'adaptent en temps réel.",
    selectIncidentHelper: "Sélectionnez un incident ou marqueur de plan pour voir les recommandations IA et affecter les équipes.",
    incidentDescTitle: "Description de l'Incident :",
    dispatchBtn: "Affecter l'Équipe",
    resolveBtn: "Marquer Résolu",
    cancelBtn: "Annuler",
    aiDispatchBtn: "Analyse d'Affectation IA",
